...
class multistageSTARSequentialEncoder(torch.nn.Module):
    def __init__(self, height, width, input_dim=4, hidden_dim=64, nclasses=15, nstage=3, nclasses_l1=3, nclasses_l2=7, kernel_size=(3,3), n_layers=6, use_in_layer_norm=False, viz=False, test=False):
